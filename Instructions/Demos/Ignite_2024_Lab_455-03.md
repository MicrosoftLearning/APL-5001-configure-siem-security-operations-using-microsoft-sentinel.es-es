...
### Tarea 1: Explorar los controles de seguridad y las recomendaciones
...
### Tarea 2: Explorar la funcionalidad Inventario
...
1. En el panel de filtro, elimina el filtro Tipo de recurso y después selecciona**Agregar filtro** y fíjate en el filtro Conclusiones de seguridad: te permite encontrar todos los recursos propensos a una vulnerabilidad específica. También puedes buscar CVE, Id. de KB, nombre y actualización que falta.
  ...
  > | Valor de búsqueda de seguridad | Lo que representa |
  > | :--- | :--- |
  > | CVE | Puntos vulnerables y exposiciones comunes |
  > | KB | Knowledge Base: normalmente parches |
  > | ID | Problemas específicos internos de Defender for Cloud |
...
### Tarea 3: Descripción de los precios
...
### Tarea 4: Introducir las funcionalidades de CWP
